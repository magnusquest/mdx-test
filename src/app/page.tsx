...
export default function ChatPage() {
  ...
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '2rem', fontFamily: 'monospace' }}>
      ...
      <div style={{ minHeight: 400, marginBottom: '1rem' }}>
        {messages.map((m) => (
          ...
          >
            <span style={{ fontSize: '0.7rem', color: '#888', marginBottom: 4 }}>{m.role}</span>
            <pre
              style={{
                whiteSpace: 'pre-wrap',
        ...
        {streaming && (
          <div style={{ color: '#888', fontSize: '0.8rem', marginBottom: '1rem' }}>▋</div>
        )}
        <div ref={bottomRef} />
      </div>
